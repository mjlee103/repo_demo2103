...
public class ZipCodeDao {
	...
	public List<Map<String,Object>> getZipCodeList(){
		...
		/*
		 * zipList = new ArrayList<>(); Map<String,Object> rmap = new HashMap<>();
		 * rmap.put("mem_name", "이순신"); zipList.add(rmap); rmap = null; rmap = new
		 * HashMap<>(); rmap.put("good_name", "비누"); zipList.add(rmap);
		 */
